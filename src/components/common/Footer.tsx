      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y md:col-span-2">
            ...
            > */}
              <img
                src={logo}
                alt="Estuscia Logo"
                className="h-25 sm:h-25 w-auto object-contain transition-transform duration-300 hover:scale-105"
              />
            {/* </div> */}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-8 text-xs text-slate-500 gap-4">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-2">
            ...
            <a href="" className="hover:text-white transition-colors">Allocations Protocol</a>
            <span className="text-slate-800">•</span>
